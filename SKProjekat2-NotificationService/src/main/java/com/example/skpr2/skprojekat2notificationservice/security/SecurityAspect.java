package com.example.skpr2.skprojekat2notificationservice.security;
...
public class SecurityAspect {
    ...
    @Around("@annotation(com.example.skpr2.skprojekat2notificationservice.security.CheckSecurity)")
